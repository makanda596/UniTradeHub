...
import { FollowUser, getFollowers, getFollowing, UnfollowUser, countFollowers, countFollowing, UsercountFollowing, UsercountFollowers } from '../controllers/FolloweControllers.js';
...
router.get('/countfollowers', verifyToken, UsercountFollowers)
router.get('/countfollowing', verifyToken, UsercountFollowing)
