...
export const deleteReview = async (req, res) => {
    ...
    try {
        ...
        // Remove the review from the User's reviews array using $pull
        await User.findByIdAndUpdate(review.recieverId, {
            $pull: { reviews: id } // Removes the review ID from the array
        });
