...
import { sendEmail, sendRestPasswordConfirmationEmail, sendEmailVerification } from "../utilis/sendEmail.js";
import { SIGNUP_SUCCESS_TEMPLATE } from "../Email.js/Emailtemplates.js";
    ...
    try {
        ...
        if (!user.isVerified) {
            return res.status(403).json({
                ...
                isVerified: false,
                userId: user._id // Send user ID for verification flow
            });
        }
