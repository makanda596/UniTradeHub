...
export const getFollowers = async (req, res) => {
    ...
    try {
        const user = await User.findById(userId)
            .populate({
                path: "followers",
                populate: { path: "followedId", select: "username  profilepic following" } // Populate follower details
            })
...
export const getFollowing = async (req, res) => {
    ...
    try {
        ...
        const user = await User.findById(userId)
            .populate({
                path: "following",
                populate: { path: "followerId", select: "username email profilepic" } // Populate followed user details
            })
            .select("username email profilepic following");
