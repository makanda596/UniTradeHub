  ...
  return (
    ...
    <Routes>
      <Route path="/settings" element={<Settings />} />
          ...
          <Route path="/Myposts/:userId" element={<ProtectedRoute><Myposts userId={user?._id} /></ProtectedRoute>} />
          ...
          <Route path="/customerreviews/:userId" element={<ProtectedRoute><Reviewspage userId={user?._id} /></ProtectedRoute>}/>
