  ...
  return (
    ...
    <Routes>
      <Route path="/settings" element={<Settings />} />
          ...
          <Route path="/Myposts/userId" element={<ProtectedRoute><Myposts user={user} userId={user}/></ProtectedRoute>} />
          ...
          <Route path="/Onepost/:Category/:postId" element={<ProtectedRoute><Onepost user={user} /></ProtectedRoute>} />
          <Route path="/customerreviews/:userId" element={<ProtectedRoute><Reviewspage user={user} userId={user?._id} /></ProtectedRoute>}/>
          <Route path="/category/:categoryName" element={<ProtectedRoute user={user}><CategoryDetails /></ProtectedRoute>} />
