            ...
            <div className="container mx-auto px-0 lg:px-10 py-8">
                ...
                {loading && (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {[...Array(6)].map((_, index) => (
                            <div key={index} className="bg-white lg:rounded-xl shadow-sm overflow-hidden">
                            ...
                            <div key={post._id} className="bg-white rounded-xl shadow-sm overflow-hidden hover:shadow-md transition duration-300 border border-gray-100">
                                ...
                                <div className="p-4">
                                    ...
                                    <div className="flex gap-2 mt-4">
                                        ...
                                        <button className="flex-1 bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded-lg text-sm font-medium transition flex items-center justify-center gap-1">
