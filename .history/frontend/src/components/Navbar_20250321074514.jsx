...
import { FaShoppingCart, FaUser, FaBars, FaTimes, FaSearch, FaChevronLeft } from "react-icons/fa";
                    ...
                    <ul className="flex flex-col items-center space-y-4">
                        ...
                        <li className="relative" ref={categoryRef}>
                            <button onClick={() => setCategoryOpen(!categoryOpen)} className="hover:text-blue-600 flex items-center">
                                Categories <FaChevronLeft className="ml-2" />
                            </button>
                            {categoryOpen && (
                                <div className="absolute left-0 top-0 mt-6 w-48 bg-white border rounded-lg shadow-lg">
                                    <ul className="text-gray-700">
                                        <li className="p-2 hover:bg-gray-100 cursor-pointer"><a href="/categories/electronics">Electronics</a></li>
                                        <li className="p-2 hover:bg-gray-100 cursor-pointer"><a href="/categories/fashion">Fashion</a></li>
                                        <li className="p-2 hover:bg-gray-100 cursor-pointer"><a href="/categories/home-appliances">Home Appliances</a></li>
                                    </ul>
                                </div>
                            )}
                        </li>
