        ...
        <div className="flex h-screen bg-gray-100">
            ...
            <div className="hidden md:block w-80 bg-white p-5 shadow-md">
                ...
                <div className="mt-5 space-x-2 flex flex-row">
                    {/* Posts Created Card */}
                    <div className="bg-blue-100 p-1 rounded-lg shadow-md items-center">
                    ...
                    <div className="bg-green-100 rounded-lg shadow-md items-center">
                    ...
                    {/* Liked Photos Card */}
                    <div className="bg-yellow-100 rounded-lg shadow-md flex flex-col items-center justify-center p-4">
                        <p className="text-gray-600 text-lg">{details?.user?.likedPhotos || 0} Photos</p>
