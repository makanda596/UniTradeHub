...
const AllPosts = ({ user }) => {
    ...
    return (
        <div className="flex flex-col w-full min-h-screen p-1 bg-gray-100">
            {!isCreating ? (
                <button
                ...
                <ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
                    {posts.length > 0 ? (
                        posts.map((post, index) => (
                            <li key={index} className="p-0 bg-gray-50 shadow-md hover:shadow-lg transition duration-300 flex flex-col gap-2">
