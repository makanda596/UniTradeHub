...
const Posts = () => {
  ...
  return (
    <div className="p-4">
      {post ? (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-gray-200 p-6 rounded-lg shadow-md">

          {/* 🔹 First Section - Images */}
          <div className="flex flex-wrap justify-center items-center bg-white p-4 rounded-lg shadow">
            <h2 className="text-xl font-bold mb-2 w-full text-center">Post Images</h2>
