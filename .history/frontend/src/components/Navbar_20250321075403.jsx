...
const Navbar = ({ logout }) => {
    ...
    const categories = [
        "Electronics", "Fashion & Clothing", "Gas Supply", "Home", "Kitchen", 
        "Furniture", "Beauty & Cosmetics", "Food & Beverages", "Salon", "Others"
    ];
            ...
            <div className="container mx-auto flex justify-between items-center p-1">
                ...
                <ul className="hidden md:flex space-x-6 text-gray-700">
                    ...
                    <li className="relative" ref={categoryRef}>
                        <button onClick={() => setCategoryOpen(!categoryOpen)} className="hover:text-blue-600">Categories</button>
                        {categoryOpen && (
