            ...
            <div className="p-2 mt-4 rounded-2xl shadow-lg bg-white mb-6">
                ...
                <div className="mt-1 flex gap-2 ">
                    {posts.slice(0, 2).map((post, index) => (
                        <div key={index} className="p-2  bg-white relative  border border-gray-200 rounded-md min-w-[250px] shadow-md hover:shadow-xl transition duration-300">
                            <Link to={`/Profile/${post?.createdBy?._id}`}> <img src={post.image} alt="Trending post" className="w-full h-40 object-cover rounded-lg mb-2" />
