            ...
            {conversations.length > 0 ? (
                conversations.map((message, index) => (
                    ...
                    >
                        ...
                        <div
                            className={`p-3 rounded-lg max-w-xs text-sm shadow-md ${message.senderId === user._id
                        ...
                        >
                            ...
                            <div className={`text-xs mt-1 ${message.senderId === user._id ? 'text-blue-100' : 'text-gray-500'}`}>
