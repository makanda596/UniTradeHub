...
import { FaRegBookmark, FaPlus, FaSignOutAlt } from "react-icons/fa";
...
const Dashboard = () => {
    ...
    return (
        <div className="flex h-screen bg-gray-100">
            ...
            {/* Right Section */}
            <div className="w-80 bg-white p-5 shadow-md">
                <div className="flex flex-col items-center">
                    <div className="w-20 h-20 bg-blue-300 rounded-full mb-3"></div>
                    <h3 className="text-lg font-semibold">Dustin</h3>
                    <p className="text-gray-500">@dustin</p>
                </div>
                <hr className="my-4" />
