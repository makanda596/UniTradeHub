    ...
    return (
        <div className="flex flex-col flex-1 max-w-xl mx-auto p-1 mt-1">
            ...
            <div className="p-6 rounded-2xl shadow-lg bg-white mb-6">
                ...
                <div className="mt-1 flex gap-4 overflow-x-auto p-4 scrollbar-hide">
                    {posts.slice(8, 12).map((post, index) => (
                        <div key={index} className="p-2  bg-white border border-gray-200 rounded-lg min-w-[250px] shadow-md hover:shadow-xl transition duration-300">
