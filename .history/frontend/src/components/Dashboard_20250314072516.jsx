...
const Dashboard = ({ user }) => {
    return (
        <div className="flex flex-col lg:flex-row h-screen pt-12 w-full bg-red-200">
            {/* User Information - Fixed on large screens */}
            <div className="pl-4 mr-6 rounded-xl shadow-lg 
                bg-white p-0 lg:fixed lg:w-[300px] lg:h-screen lg:overflow-auto">
            ...
            <div className="lg:ml-[320px] flex flex-col lg:flex-row flex-1 px-4 gap-4">
                {/* Main Content */}
