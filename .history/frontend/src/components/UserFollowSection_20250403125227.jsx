...
const UserFollowSection = () => {
    ...
    console.log(usercountfollowers.count)
    console.log(usercountfollowers)
    useEffect(() => {
            ...
            {isPopupOpen && (
                <div className="fixed inset-0 flex items-center justify-center  z-50">
                    <div className="bg-blue-200 p-6 rounded-lg shadow-lg w-80">
                        ...
                        <div>
                            {activetab === "followers" ? (
                                <FollowersPopUp loading={loading} followers={userfollowers} />
                            ) : (
                            <FollowingPopUp loading={loading} following={userfollowing }/>
                            )}
                        </div>
                        <button
