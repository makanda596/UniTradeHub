...
const CreatePost = ({ user }) => {
  ...
  const handleImageChange = (e) => {
    ...
    setImages(files); // Store selected files
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      images.forEach((img) => formData.append("images", img)); // Append images

      await axios.post(`http://localhost:5000/posts/createpost/${user._id}`, formData, {
