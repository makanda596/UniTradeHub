        ...
        <div className="p-2 rounded-2xl shadow-lg bg-white w-80">
            ...
            <ul className="flex flex-col gap-2">
                {categories.map((category, index) => (
                    <a href={category.link} key={index} className={`flex items-center gap-2 p-3 rounded-lg cursor-pointer ${category.bgColor} hover:shadow-md transition duration-300`}>
