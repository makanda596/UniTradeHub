...
const Dashboard = ({ logout }) => {
    ...
    return (
        <div className="flex h-screen bg-gray-100">
            ...
            {/* Right Section */}
            <div className="hidden md:block w-80 bg-white p-5 shadow-md flex flex-col">
                {/* User Profile Section */}
                <div className="flex flex-col items-center">
                    <img src={details?.user?.profilepic} className="object-cover h-20 w-20 rounded-full mb-3" alt="Profile" />
                ...
                <div className="mt-5 space-x-2 flex flex-row">
                    {/* Posts Created Card */}
                    <div className="bg-blue-100 p-1 rounded-lg shadow-md flex flex-col items-center justify-center p-1">
                        <p className="text-gray-600">{details?.user?.postsCreated || 0} </p>
                        <h3 className="text-sm font-semibold text-blue-800">Posts Created</h3>
                    </div>

                    {/* Items Bookmarked Card */}
                    <div className="bg-green-100 rounded-lg shadow-md flex flex-col items-center justify-center p-1">
                        <p className="text-gray-600">{details?.user?.bookmarkedItems || 0} </p>
                        <h3 className="text-sm font-semibold text-green-800 ">Items Bookmarked</h3>
                    </div>

                    {/* Liked Photos Card */}
                    <div className="bg-yellow-100 rounded-lg shadow-md flex flex-col items-center justify-center p-1">
                        <p className="text-gray-600 text-lg">{details?.user?.likedPhotos || 0} </p>
            ...
            <h3 className="text-lg font-semibold mt-6 mb-2">Trending</h3>
