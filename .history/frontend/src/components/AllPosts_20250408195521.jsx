                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="flex items-center gap-2 relative">
                                        ...
                                        <BsThreeDotsVertical
                                            ...
                                            className="cursor-pointer text-xl text-gray-600 hover:text-gray-800 transition duration-200"
                                        />

                                        {/* Dropdown menu */}
                                        {openTab && (
                                            <div className="absolute -top-10 right-0 bg-white border border-gray-200 shadow-xl p-4 rounded-lg z-50 w-60 flex flex-col gap-3">
                                                {/* Close button */}
