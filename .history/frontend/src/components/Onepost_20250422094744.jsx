...
const PostPage = () => {
  ...
  return (
    <>
    <Navbar/>
    <div className="flex flex-col md:flex-row items-center md:items-start p-8 max-w-6xl mx-auto bg-gray-50 rounded-xl shadow-lg md:mt-6">
      ...
      <div className="w-full md:w-1/2 md:pl-8 mt-6 md:mt-6">
