  ...
  return (
    <div className="flex flex-col md:flex-row items-center md:items-start p-8 max-w-6xl mx-auto bg-gray-50 rounded-xl shadow-lg">
      ...
      <div className="w-full md:w-1/2 md:pl-8 mt-6 md:mt-0">
        ...
        <p className="text-gray-600 mt-2 text-md">{post?.location || "Location not specified"}</p>
        ...
        {/* Pricing */}
        <p className="text-xl font-bold text-green-600 mt-4">${post?.price || "N/A"}</p>
        ...
        <div className="flex space-x-2 mt-4">
          <button className="bg-blue-600 hover:bg-blue-700 text-white px-62 py-2 rounded-lg shadow-md transition duration-300">
            Contact Seller
          </button>
