                            ...
                            <li key={index} className="pl-4 pb-4 bg-white shadow-md hover:shadow-lg transition duration-300 flex flex-col gap-2">
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="flex items-center gap-2 relative">
                                        ...
                                        {openPostId === post._id && (
                                            <div className="absolute  w-full -top-20 right-4 flex flex-col items-start space-y-2 bg-white shadow-lg p-4 rounded-xl z-50">
                                                <button
                                                ...
                                                <button
                                                    ...
                                                    className="bg-red-500 text-white w-full px-4 py-2 rounded-md hover:bg-red-600 transition duration-200 text-sm font-semibold"
                                                >
                                                    Report
                                                </button>
                                                ...
                                                <button
                                                    ...
                                                    className="bg-blue-500 text-white px-4 py-2 w-full rounded-md hover:bg-green-600 transition duration-200 text-sm font-semibold"
                                                >
                                                    Share Post
                                                </button>
                                            </div>
