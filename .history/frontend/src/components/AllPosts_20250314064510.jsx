                ...
                <ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
                    {posts.length > 0 ? (
                        posts.map((post, index) => (
                            <li key={index} className="pl-4 bg-gray-50 shadow-md hover:shadow-lg transition duration-300 flex flex-col gap-2">
                                ...
                                <div>
                                    <h3 className="text-xl font-bold text-gray-800">product{post.productName}</h3>
                                    <p className="text-gray-600">{post.description}</p>
                                </div>
...
<div className="border-1 border-gray-400 w-full mb-[-10px]"></div>
                                <div className="flex justify-between items-center mt-0 text-gray-600">
                                    ...
                                    <button onClick={handleComment} className="flex items-center  hover:text-blue-600 transition">
                                        <FaComment /> Comment
                                    </button>
