...
const PostPage = () => {
  ...
  return (
    <>
    <Navbar/>
    <div className="flex flex-col md:flex-row items-center md:items-start py-14 md:px-4 max-w-6xl mx-auto  ">

      <div className="w-full  flex flex-col items-center">
        <img
          src={post.image}
          alt="Post"
          className="w-full h-82 md:96 rounded-none md:rounded-lg md:shadow-md object-cover"
        />
