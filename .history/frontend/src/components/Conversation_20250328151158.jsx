                ...
                <div className="space-y-2">
                    {conversations.map((message, index) => {
                        ...
                        return (
                            <div
                                key={index}
                                className={`flex items-start ${isCurrentUser ? "justify-end" : "justify-start"} ${isPreviousSameSender ? "mt-1" : "mt-2"}`}
                            >
                                {!isCurrentUser && (
                                ...
                                <div className={`flex flex-col ${isCurrentUser ? "items-end" : "items-start"} mx-1 max-w-[80%]`}>
                                    ...
                                    >
                                        ...
                                        <div className={`text-xs mt-1 flex ${isCurrentUser ? 'justify-end' : 'justify-start'}`}>
                                            ...
                                            {isCurrentUser && (
                                                <span className="ml-1">
                                                    {message.seen ? (
                                                        <svg className="w-3 h-2 text-indigo-300" fill="currentColor" viewBox="0 0 20 20">
