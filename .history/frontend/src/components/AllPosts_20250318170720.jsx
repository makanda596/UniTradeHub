                    ...
                    {posts.slice(8, 12).map((post, index) => (
                        <div key={index} className="p-2  bg-white border border-gray-200 rounded-md min-w-[250px] shadow-md hover:shadow-xl transition duration-300">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                />
                                <div>
                                    <p className="text-sm font-bold text-gray-800">{post?.createdBy?.username || "Unknown"}</p>
                                    <p className="text-md font-sans text-gray-900 mt-0">{post.productName}</p>
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs font-medium text-blue-500">{post?.createdBy?._id || "N/A"}</p>
