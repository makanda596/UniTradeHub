...
const Navbar = ({ logout }) => {
    ...
    return (
        <nav className="bg-white shadow-md fixed w-full z-10">
            ...
            {/* Mobile Menu */}
            {isOpen && (
                <div className="md:hidden w-full h-screen bg-gray-100 shadow-md p-4 overflow-y-auto">
                    <ul className="space-y-4">
                        ...
                        <li><Link to="/profile" className="block hover:text-blue-600 flex items-center"><FaUser size={24} className="mr-2" /> My Account</Link></li>
                        <li>
                        ...
                        <li>
                            <button className="block px-4 py-2 text-gray-700 hover:bg-gray-200 cursor-pointer">
