            ...
            {isOpen && (
                <div className="md:hidden fixed top-0 left-0 w-3/4 h-full bg-gray-100 shadow-md p-6 overflow-y-auto z-50">
                    ...
                    <ul className="mt-8 space-y-4 text-gray-700">
                        <li><Link to="/" className="block hover:text-blue-600 border-1 border-blue-500 py-2">Home</Link></li>
                        <li>  <Link
                            to="/Settings"
                            className="flex items-center gap-2 px-4 py-2 w-full border-1 border-blue-500 text-gray-700 hover:bg-gray-100 rounded-lg"
                        >
