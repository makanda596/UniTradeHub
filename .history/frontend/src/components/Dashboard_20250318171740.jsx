...
const Dashboard = ({ user }) => {
    return (
        <div className="flex flex-col lg:flex-row  pt-12 lg:px-10 px-0 bg-gray-400">
            {/* User Information - Fixed on large screens */}
            <div className="pl-4 mr-0 rounded-sm md:rounded-xl shadow-lg 
                bg-white  lg:fixed lg:w-[300px] lg:h-screen lg:overflow-auto">
