...
const AllPosts = ({ user }) => {
    ...
    return (
        <div className="flex flex-col flex-1 max-w-xl mx-auto p-0 mt-1">
            <div className="flex gap-2 justify-center items-center bg-white py-4">
          <img src={user?.profilepic} alt="" className="w-12 h-12 object-cover"/>  {!isCreating ? (
            ...
            <div className="p-2 mt-4 rounded-2xl shadow-lg w-full bg-white mb-6">
                <h1 className="text-lg font-bold  text-gray-800">Trending Posts</h1>
