...
const AllPosts = ({ user }) => {
    ...
    const handleSaveClick = (postId, postName) => {
        setSelectedPost({ id: postId, name: postName });
        const response = await axios.post(`${import.meta.env.VITE_BACKEND_URL}/carts/addCart/${postId}`)
    };
                                    ...
                                    <div className="flex items-center gap-2 relative">
                                        ...
                                        {openPostId === post._id && (
                                            <div className="absolute  w-full -top-20 right-4 flex flex-col items-start space-y-2 bg-white shadow-lg p-4 rounded-xl z-50">
                                                ...
                                                <button
                                                    onClick={() => handleSaveClick(post._id, post.productName)}
