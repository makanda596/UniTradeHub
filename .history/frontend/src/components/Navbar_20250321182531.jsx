...
import {
    ...
    FaCouch, FaCut, FaStore, FaEllipsisH, FiChevronDown
} from "react-icons/fa";
                ...
                <div className="flex items-center space-x-6">
                    ...
                    <div className="relative" ref={userDropdownRef}>
                        <button
                            ...
                            className="flex items-center cursor-pointer hover:text-blue-600  text-black space-x-2"
                        >
                            <FaUser size={24} />
                            <span>{user?.username}  <FiChevronDown size={18} /></span>
                        </button>
                ...
                <div className="md:hidden fixed top-0 left-0 w-3/4 h-full bg-gray-100 shadow-md p-6 overflow-y-auto z-50">
                    ...
                    <ul className="mt-8 space-y-4 text-gray-700">
                        ...
                        <li className="mt-4">
                            <button
                                onClick={logout}
                                className="block px-4 py-2 text-gray-700 hover:bg-gray-200 cursor-pointer w-full text-left"
                            >
                                Logout
                            </button>
                        </li>
