...
const Posts = () => {
  ...
  return (
    <div className="p-4">
      {post ? (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-2 bg-gray-200 p-6 rounded-lg shadow-md w-full py-10">

          {/* 🔹 First Section - Images */}
          <div className="flex flex-wrap justify-center items-center bg-white  rounded-lg shadow w-1/4">
