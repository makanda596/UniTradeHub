...
const Navbar = ({logout}) => {
    ...
    return (
        <nav className="bg-white shadow-md fixed  w-full z-1">
            <div className="container mx-auto justify-centre flex md:justify-between items-center p-1">
            ...
            {/* Mobile Menu */}
            {isOpen && (<div className="md:hidden w-96 h-screen bg-gray-100 shadow-md p-4 overflow-y-auto">
                    <ul className="flex flex-col items-start space-y-4">
                        <li><a href="/" className="hover:text-blue-600">Home</a></li>
                        <li><a href="/shop" className="hover:text-blue-600">Shop</a></li>
                            
                        <li><a href="/shop" className="hover:text-blue-600 flex items-center"><FaUser size={24} />My Account</a></li>
                        <h1 className="text-d  mb-2 text-gray-800 text-center">View Categories</h1>
                        ...
                        <li><button className="hover:text-blue-600">{logout} logout</button></li>
                    </ul>\
                    </ul>
                </div>
            )}
