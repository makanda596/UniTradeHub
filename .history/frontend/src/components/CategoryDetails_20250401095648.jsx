                            ...
                            <div key={post._id} className="bg-white rounded-xl shadow-sm overflow-hidden hover:shadow-md transition duration-300 border border-gray-100">
                                ...
                                <div className="p-4">
                                    ...
                                    <div className="flex gap-2 mt-4">
                                        ...
                                        <Link to={`/Chart/${post?.createdBy?._id}`}> <button className="flex bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded-lg text-sm font-medium transition flex items-center justify-center gap-1">
                                            Contact Seller
                                        </button></Link>
                                    </div>
                                </div>
