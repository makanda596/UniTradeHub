...
const FollowSection = () => {
    ...
    const { fetchFollowing, fetchFollowers, countfollowers, countfollowersfunction,followers, following, countfollowing } = FollowStore()
 const {userId} = useParams()
    ...
    useEffect(() => {
        ...
        fetchData();
        console.log(userId)
    }, [userId, fetchFollowing, fetchFollowers, countfollowersfunction]);
    const openFollowers = () => {
