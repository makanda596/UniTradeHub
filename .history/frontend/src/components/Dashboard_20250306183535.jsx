        ...
        <div className="flex h-screen bg-gray-100">
            ...
            <div className="hidden md:block w-80 bg-white p-5 shadow-md">
                ...
                <div className="mt-5 space-x-2 flex flex-row">
                    {/* Posts Created Card */}
                    <div className="bg-blue-100 p-1 rounded-lg shadow-md">
                    ...
                    <div className="bg-green-100 p-4 rounded-lg shadow-md">
                        <h3 className="text-lg font-semibold text-green-800">Items Bookmarked</h3>
                        <p className="text-gray-600">{details?.user?.bookmarkedItems || 0} Items</p>
                    </div>

                    {/* Liked Photos Card */}
                    <div className="bg-yellow-100 p-4 rounded-lg shadow-md">
                        <h3 className="text-lg font-semibold text-yellow-800">Liked Photos</h3>
