...
const Categories = () => {
    ...
    return (
        <div className="p-5 rounded-2xl shadow-lg bg-white w-full max-w-xs mx-auto">
            ...
            <ul className="flex flex-col gap-3">
                {categories.map((category, index) => (
                    <Link
                        ...
                        key={index}
                        className={`flex items-center gap-3 p-4 rounded-xl cursor-pointer ${category.bgColor} hover:shadow-md transition duration-300 transform hover:scale-105`}
                    >
