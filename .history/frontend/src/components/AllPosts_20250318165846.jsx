            ...
            <div className="p-6 rounded-2xl shadow-lg bg-white mb-6">
                ...
                <div className="mt-8 flex gap-6 overflow-x-auto p-4 scrollbar-hide">
                    {posts.slice(8, 12).map((post, index) => (
                        <div key={index} className="p-4 bg-white border border-gray-200 rounded-lg min-w-[250px] shadow-md hover:shadow-xl transition duration-300">
                            ...
                            <h3 className="text-lg font-semibold text-gray-900 mt-2">{post.productName}</h3>
