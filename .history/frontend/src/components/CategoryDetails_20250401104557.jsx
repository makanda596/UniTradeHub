        ...
        const fetchPosts = async () => {
            try {
                ...
                const response = await axios.get(
                    `http://localhost:5000/posts/posts?category=${categoryName}`,
                    {
                            ...
                            <div key={post._id} className="bg-white rounded-xl shadow-sm overflow-hidden hover:shadow-md transition duration-300 border border-gray-100">
                                ...
                                <div className="p-4">
                                    ...
                                    <div className="mb-0">
                                        ...
                                        <p className="text-gray-600 text-sm line-clamp-2 mb-1">{post.description.length > 3 ? (<div>{post.description.filter(0,3)}</div>) : (<>{post.description}</>)}</p>
                                    </div>
