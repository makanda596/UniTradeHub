...
const SavePost = ({ savepopUp, setSavePopUp, postId, postName }) => {
            ...
            {savepopUp && (
                <div className="fixed inset-0  flex items-end justify-center z-50 ">
                    <div className="bg-white p-4 rounded-none shadow-2xl max-w-md w-full mx-4 transition-all duration-300 ease-out">
                        <h3 className="text-xl font-bold text-gray-800 mb-2">save Post</h3>
                        ...
                        >
                            ...
                            <option value="False Informationt">False Information</option>
