...
const Dashboard = ({ user }) => {
    return (
        <div className="flex flex-col lg:flex-row  pt-12 lg:px-10 px-0 bg-white">
            {/* User Information - Fixed on large screens */}
            <div className="pl-4 rounded-sm md:rounded-xl shadow-lg 
                bg-gray-200  lg:fixed lg:w-[300px] lg:h-screen lg:overflow-auto">
            ...
            <div className="lg:ml-[320px] flex flex-col lg:flex-row w-full gap-4 px-2">
                {/* All Posts */}
