        ...
        <div className="fixed inset-0 flex items-center justify-center  z-50">
            <div className="bg-white p-6 rounded-lg shadow-lg w-96 relative">
                ...
                <div className="bg-blue-100 p-4 rounded-md text-blue-700 text-sm">
                    <p><strong>Note:</strong> Your review will be <span className="font-semibold">anonymous</span>. The seller will see your feedback but won’t know who submitted it.</p>
