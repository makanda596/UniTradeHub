...
const CreatePost = ({ user, onClose, onPostCreated }) => {
  ...
  return (
    <div className="fixed ml-8 lg:ml-96 inset-0 bg-opacity-100 flex items-center w-96 justify-center p-2 bg-red-300 z-50">
      <div className="bg-blue-400 rounded-xl shadow-xl w-full max-w-md max-h-[90vh] overflow-y-auto">
        {/* Header */}
