...
const GuestNavbar = () => {
    ...
    return (
        <nav className="bg-white shadow-md px-6 py-2 relative z-50 fixed top-2 position-sticky">
            ...
            {isOpen && (
                <div className="md:hidden absolute left-0 top-full w-full bg-white shadow-lg py-4 px-6 mt-2 animate-slide-down">
