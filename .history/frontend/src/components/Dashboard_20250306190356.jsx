        ...
        <div className="flex h-screen ">
            ...
            <div className=" md:block w-80 space-y-4 p-5 shadow-md flex flex-col">
                ...
                <div className="mt-5 space-x-2 flex flex-row">
                    {/* Posts Created Card */}
                    <div className="border-amber-600 border-2 p-1 rounded-lg shadow-md flex flex-col items-center justify-center ">
                    ...
                    {/* Items Bookmarked Card */}
                        <div className="border-amber-600 border-2 rounded-lg shadow-md flex flex-col text-bold items-center justify-center p-1">
