...
const Dashboard = ({ user, userId }) => {
    ...
    const countPosts = async () => {
        try {
            ...
            const response = await axios.get(`https://unitradehubback.onrender.com/auth/countposts/${userId}`);
    ...
    const countReview = async () => {
        try {
            ...
            const response = await axios.get('https://unitradehubback.onrender.com/auth/countReviews, {
