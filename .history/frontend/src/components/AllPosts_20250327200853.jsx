...
import { FaThumbsUp, FaComment, FaShare, FaWhatsapp, FaSearch } from "react-icons/fa";
...
const AllPosts = ({ user }) => {
    ...
    return (
        <div className="flex flex-col flex-1 max-w-xl mx-auto p-1 mt-1">
            ...
            <div className="p-2 mt-4 rounded-2xl shadow-lg bg-white mb-6">
                <h1 className="text-xl font-bold text-gray-800">Trending Posts</h1>
                <div className="mt-1 flex gap-4 overflow-x-auto p-0 scrollbar-hide">
                    {filteredPosts.slice(0, 4).map((post, index) => (
                        <div key={index} className="p-2 bg-white border border-gray-200 rounded-md min-w-[250px] shadow-md hover:shadow-xl transition duration-300">
                            <img src={market} alt="Trending post" className="w-full h-40 object-cover rounded-lg mb-2" />
                            <div className="flex items-center gap-2">
                                ...
                                <div>
                                    <a href={`/Profile/${post?.createdBy?._id}`} className="text-md font-bold text-gray-800 hover:underline hover:text-blue-400">
            ...
            <div className="p-0">
                <h1 className="text-xl font-bold text-gray-800 mb-4 ml-6">
