                    ...
                    >
                        <div className="relative">
                            ...
                            {post?.createdBy?.profilepic ? (
                                <img
                                    ...
                                    className="absolute bottom-2 left-2 w-10 h-10 object-cover rounded-full border-2 border-white dark:border-gray-900 shadow-sm"
                                />
                            ) : (
                        ...
                        <div className="p-4">
                            ...
                            <div className="mt-3 flex items-center justify-between">
                                ...
                                {/* You can add price or other relevant info here */}
                                {post.price && (
