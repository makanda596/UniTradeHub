    ...
    <div className="p-6 max-w-5xl mx-auto bg-white shadow-md rounded-md">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="flex mt-4 space-x-2">
            {product.images.map((img, index) => (
              <img
                ...
                src={img}
                alt={`Thumbnail ${index}`}
                className={`w-16 h-16 object-cover rounded-md cursor-pointer border ${selectedImage === img ? "border-red-500" : "border-gray-300"
                  }`}
        ...
        <div>
          ...
          <p className="text-red-600 text-lg font-bold">{product.rating} ⭐ ({product.reviews} reviews)</p>
          ...
          <div className="mt-4 text-xl font-bold">
            <span className="text-red-600">KSh {product.price}</span>
            <span className="line-through text-gray-500 ml-2">KSh {product.originalPrice}</span>
