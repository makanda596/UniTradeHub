                                    ...
                                    <div className="flex items-center gap-2 relative">
                                        ...
                                        {openTab && (
                                            <div className="absolute -top-20 right-0 bg-white border border-gray-200 shadow-xl p-2 rounded-lg z-50 w-60 flex flex-col gap-3">
                                                ...
                                                <button
                                                    className="w-full bg-blue-500 text-white py-1 rounded-md hover:bg-red-600 transition text-sm font-semibold"
                                                >
                                                   share post
                                                </button>
                                                    ...
                                                    className="w-full bg-white text-white py-1 rounded-md hover:bg-red-600 transition text-sm font-semibold"
                                                >
