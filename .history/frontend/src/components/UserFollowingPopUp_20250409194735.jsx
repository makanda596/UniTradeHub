...
const UserFollowingPopUp = ({ userfollowers, loading, error }) => {
    return (
                ...
                <div className="space-y-2">
                    {userfollowers.length > 0 ? (
                        userfollowers.map((user) => (
                            <div
                                key={user._id}
                                className="group bg-gray-100 flex items-center justify-between p-2 hover:bg-gray-50 rounded-lg transition-all duration-200"
                            >
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="font-medium text-gray-800">
                                            {user?.followedId?.username || "Unknown User"}
                                        </p>
