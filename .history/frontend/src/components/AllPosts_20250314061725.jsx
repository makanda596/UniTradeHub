                            ...
                            <li key={index} className="p-6 bg-gray-50 rounded-lg shadow-md hover:shadow-lg transition duration-300 flex flex-col gap-4">
                                ...
                                <div className="flex justify-between items-center mt-4 text-gray-600">
                                    ...
                                    {post?.createdBy?.phoneNumber && (
                                        <a href={generateWhatsAppLink(post.createdBy.phoneNumber, post)} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-green-600 transition">
                                            <FaWhatsapp /> WhatsApp
                                        </a>
                                    )}
