        ...
        <div className="flex h-screen bg-gray-100 p-6">
            ...
            <div className="w-1/4 bg-white p-6 mr-6 rounded-2xl shadow-lg">
                ...
                <div className="mt-4 p-4 bg-gray-100 rounded-lg">
                    <p className="text-gray-700 flex justify-between"><span>Profile viewers</span> <span className="text-blue-600">48</span></p>
                    <p className="text-gray-700 flex justify-between mt-2"><span>Post impressions</span> <span className="text-blue-600">21</span></p>
                </div>
