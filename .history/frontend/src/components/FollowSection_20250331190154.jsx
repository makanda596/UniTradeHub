...
const FollowSection = () => {
    ...
    return (
        <div>
            <div className="bg-white rounded-xl shadow-sm p-2 border-l-2 border-gray-500">
                <div className="flex items-center justify-center gap-2">
                    ...
                    <button
                        ...
                        className="relative group flex flex-col items-center p-4 w-32 rounded-lg hover:from-blue-100 hover:shadow-md"
                    >
