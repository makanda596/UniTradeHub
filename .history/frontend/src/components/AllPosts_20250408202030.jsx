                            ...
                            <li key={index} className="pl-4 pb-4 bg-white shadow-md hover:shadow-lg transition duration-300 flex flex-col gap-2">
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="flex items-center gap-2 relative">
                                        ...
                                        {openPostId === post._id && (
                                            <div className="fixed top-34 justify-center flex items-center space-x-3 bg-white shadow-lg p-3 rounded-xl z-50">
                                                <button
                                        ...
                                        {/* Dropdown menu */}
                                        {/* {openTab && (
                                            <div className="absolute top-20 right-0 bg-white border border-gray-200 shadow-xl p-2 rounded-lg z-50 w-60 flex flex-col gap-3">
                                                {/* Close button */}
                                                <div className="flex justify-end">
                                                    <button
                                                        onClick={() => setOpenTab(false)}
                                                        className="text-gray-400 text-xl hover:text-red-500 transition"
                                                    >
                                                        <MdCancel />
                                                    </button>
                                                </div>
                                                <button
                                                    onClick={() => handleShare(post._id, post.productName)}
                                                    className="w-full bg-blue-500 text-white py-1 rounded-md hover:bg-green-600 transition text-sm font-semibold"
                                                >
                                                    Share Post
                                                </button>
                                                                               ...
                                                                               <button
                                                    onClick={() => handleReportClick(post._id, post.productName)}
                                                    className="w-full bg-white text-white py-1  text-sm font-semibold"
                                                >
                                                    <FollowButton userId={post?.createdBy?._id} />
                                                </button>
                                                <button
                                                    onClick={() => handleReportClick(post._id, post.productName)}
                                                    className="w-full bg-red-500 text-white py-1 rounded-md hover:bg-red-600 transition text-sm font-semibold"
                                                >
                                                    Report
                                                </button>
                                            </div>
