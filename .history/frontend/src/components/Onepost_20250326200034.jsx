...
const ProductDetails = () => {
  ...
  useEffect(() => {
    const fetchPost = async () => {
      try {
        const response = await axios.post("http://localhost:5000/post-details", { id: postId });
    ...
    <div className="p-6 max-w-5xl mx-auto bg-white shadow-md rounded-md">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="flex flex-col items-center">
          <img src={selectedImage} alt="Post" className="w-full h-72 object-cover rounded-md shadow-lg" />
