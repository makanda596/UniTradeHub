...
import FollowersFollowingPopup from "./FollowersFollowing";
                  ...
                  <>      <div className="bg-white rounded-xl shadow-sm p-6 border-l-4 border-purple-500">
                    <div className="flex gap-8">
                      ...
                      <button
                        ...
                        className="flex flex-col items-center hover:bg-gray-50 rounded-lg p-3 transition-all cursor-pointer"
                      >
                        ...
                        {countfollowers?.count > 0 && (
                          <span className="mt-1 text-xs text-purple-400 hover:text-purple-600">
                            View all
                          </span>
                        )}
                      </button>
