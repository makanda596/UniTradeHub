...
const ProfilePage = ({ user, logout, userId }) => {
  ...
  const { countfollowersfunction, countfollowers, countfollowing, countfollowingfunction } = FollowStore()
            ...
            {activeTab === "overview" && (
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  ...
                  {/* follow section*/}
                  <div className="bg-white rounded-xl shadow-sm p-6 border-l-4 border-purple-500 gap-10">
                    <button className="bg-green-400">{countfollowers.count || "no followers"}</button> 
                      <button className="bg-blue-400">{countfollowing.count || "no following"}</button> 
