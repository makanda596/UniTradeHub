        ...
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <div className="w-full md:w-1/3 space-y-6">
            <div className="bg-white rounded-xl shadow-sm overflow-hidden">
              ...
              >
                <div className="absolute -bottom-12 left-">
                  <div className="relative">
                    <img
                      src={user?.profilepic || "/default-profile.png"}
                      alt="Profile"
                      className="w-24 h-24 rounded-full border-2 border-blue-00 shadow-lg object-cover"
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="pt-16 px-6 pb-2">
                ...
                <div className="mt-6 flex space-x-3">
                  ...
                  <button
                    ...
                    className="flex items-center justify-center px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-lg transition flex-1"
                  >
