...
import { FaWhatsapp, FaShoppingCart, FaEnvelope, FaMapMarkerAlt, FaUserEdit } from "react-icons/fa";
          ...
          <div className="w-full md:w-1/3 space-y-6">
            <div className="bg-white rounded-xl shadow-sm overflow-hidden">
              ...
              <div className="pt-12 px-6 pb-2">
                ...
                {/* i will make this button to chart directly on whatsapp later */}
                  {/* <button
                    onClick={handleWhatsAppClick}
                    disabled={!user?.phoneNumber}
                    className={`flex items-center justify-center px-4 py-2 rounded-lg ${user?.phoneNumber ? 'bg-green-500 hover:bg-green-600 text-white' : 'bg-gray-200 text-gray-500 cursor-not-allowed'} transition flex-1`}
                  >
                  ...
                  <button
                    ...
                    className="flex items-center justify-center px-2 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-lg transition flex-1"
                  >
                    <FaEnvelope className="mr-2" />
                    Message
                  </button>
                  <button
                    onClick={reviewPopup}                    className="flex items-center justify-center px-2 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-lg transition flex-1"
                  >
                    <FaEnvelope className="mr-2" />
                   leav a review
                  </button>
                ...
                <div className="mt-6 pt-6 border-t border-gray-200">
                  <h3 className="font-medium text-gray-700 mb-3">Seller Rating</h3>
                  {isActive === "false" && <Review followedId={userId} /> }
                    ...
                    {user.posts.map((post) => (
                      <div key={post._id} className="border border-gray-200 rounded-xl overflow-hidden hover:shadow-md transition">
                        ...
                        <div className="p-4">
                          ...
                          <p className="mt-2 text-gray-600 text-sm line-clamp-2">{post.description}</p>
