  ...
  return (
    <div className="flex flex-col md:flex-row md:p-10 bg-gray-50 gap-6">
      ...
      <div className="w-full md:w-1/4 md:sticky md:top-10 h-fit">
        <div className="relative h-screen w-full bg-cover bg-center flex items-center justify-center" style={{ backgroundImage: `url(${market})` }}>
          <div className="bg-white h-30 p-6 rounded-xl shadow-lg relative bg-cover bg-center">
            <img
