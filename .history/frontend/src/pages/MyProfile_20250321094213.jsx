      ...
      <main className="flex-1 p-6">
        ...
        <ul className="space-y-2 text-gray-700 bg-white p-1 rounded-lg shadow-md">
          <a
            ...
            className="flex items-center space-x-3 hover:bg-blue-50 p-2 rounded-md transition duration-200"
          >
            <FaShoppingCart className="text-blue-500" />
            <span className="font-medium">My Posts</span>
          </a>
          <li className="flex items-center space-x-3 hover:bg-green-50 p-2 rounded-md cursor-pointer transition duration-200">
            <FaInbox className="text-green-500" />
            <span className="font-medium">Inbox</span>
          </li>
          <li className="flex items-center space-x-3 hover:bg-red-50 p-2 rounded-md cursor-pointer transition duration-200">
            <FaHeart className="text-red-500" />
            <span className="font-medium">Wishlist</span>
          </li>
          <a
            href="/Settings"
            className="flex items-center space-x-3 hover:bg-gray-50 p-2 rounded-md transition duration-200"
          >
