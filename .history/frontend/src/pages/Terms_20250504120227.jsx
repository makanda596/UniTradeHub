...
const Terms = () => {
  return (
    <div className="p-6 max-w-4xl mx-auto text-gray-800 space-y-6">
      ...
      <p>
        This Privacy Policy outlines how Unitrade Hub ("we", "us", or "our") collects, uses, stores,
        and shares your personal data when you access or use our website, mobile app, and services
