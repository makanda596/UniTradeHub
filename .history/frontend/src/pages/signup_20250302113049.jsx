            ...
            <div className="bg-blue-600 p-8 rounded-lg shadow-md w-96 text-white">
                ...
                <form onSubmit={handleSubmit}>
                    <div className="mb-4">
                        ...
                        <input type="text" className="w-full px-2 py-1 border rounded mt-1 text-black" value={username} onChange={(e) => setUsername(e.target.value)} required />
                    </div>
                    <div className="mb-4">
                        <label className="block">Email</label>
                        <input type="email" className="w-full px-2 py-1 border rounded mt-1 text-black" value={email} onChange={(e) => setEmail(e.target.value)} required />
                    </div>
                    <div className="mb-4">
