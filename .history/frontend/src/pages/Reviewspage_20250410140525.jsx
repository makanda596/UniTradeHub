...
const Reviewspage = ({ userId, user }) => {
    ...
    const fetchReview = async () => {
        try {
            ...
            const response = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/reviews/getReview/${userId}`, {
            ...
            Swal.fire({
                ...
                footer: '<a href="">Refresh the page to try again</a>'
            });
        } finally {
            setLoading(false);
        }
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="max-w-4xl mx-auto px-4 py-8">
                ...
                <div className="bg-white rounded-xl shadow-sm p-6 mb-6">
                    <h1 className="text-xl font-bold text-gray-800 mb-2">Customer Reviews</h1>
