...
import { FaUser, FaEnvelope, FaPhone, FaMapMarkerAlt, FaKey, FaTrash, FaSave } from "react-icons/fa";
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                    ...
                    await axios.delete(`${import.meta.env.VITE_BACKEND_URL}/auth/delete/${user?._id}`, {
                        headers: { Authorization: `Bearer ${token}` },
                    });
