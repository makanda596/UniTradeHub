...
const Signup = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.log(error.response ? error.response.data.message : 'Sign up failed'); countFollwers
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <div className="flex justify-center items-center h-screen bg-cover bg-center" style={{ backgroundImage: "url('/background-image.jpg')" }}>
            ...
            <div className="flex max-w-4xl w-full bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div className="hidden md:block md:w-1/2 bg-cover bg-center" style={{ backgroundImage: {signupImage }}}>
