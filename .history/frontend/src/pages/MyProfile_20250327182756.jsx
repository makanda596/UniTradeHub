  ...
  return (
    ...
    <div className="flex flex-col md:flex-row min-h-screen bg-gray-100">
      ...
      <aside className="hidden md:block w-64 bg-white p-5 shadow-lg">
        ...
        <Link to={`/customerreviews/${user?._id}`}>  <li className="flex items-center space-x-3 hover:bg-gray-200 p-2 rounded-md cursor-pointer">
            <FaInbox className="text-green-500" /> <span>Customer Reviews</span>
          </li></Link> 
      ...
      <main className="flex-1 p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div className="bg-white p-5 shadow-md rounded-lg border-l-4 border-green-500 hover:shadow-lg transition">
            ...
            <p className="text-gray-600">
              Customer`s Reviews: <span className="font-bold text-red-500">{countReviews || "0"}</span>
            </p>
          </div>
