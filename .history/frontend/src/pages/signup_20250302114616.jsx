            ...
            <div className="bg-white p-8 rounded-lg shadow-md w-96 text-blue-600">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-4">
                        ...
                        <input type="text" className="w-full px-2 py-1 border rounded mt-0 text-black" value={gender} onChange={(e) => setGender(e.target.value)} required />
                    ...
                    <button type="submit" className="w-full text-white bg-blue-600 py-2 rounded cursor-pointer">Signup</button>
                </form>
