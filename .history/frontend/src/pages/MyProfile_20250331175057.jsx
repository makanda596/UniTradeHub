              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  ...
                  <div className="bg-white rounded-xl shadow-sm p-6 border-l-4 border-purple-500 gap-10 space-x-6">
                    <button className="p-2 bg-green-400" onClick={openFollowers}>{countfollowers.count || "no followers"}</button> 
                    <button className="p-2 bg-blue-400" onClick={openFollowing}>{countfollowing.count || "no following"}</button> 
