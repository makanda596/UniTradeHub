...
const Signup = () => {
    ...
    return (
        <div className="flex justify-center items-center h-screen bg-cover bg-center" style={{ backgroundImage: "url('/background-image.jpg')" }}>
            <div className="bg-white p-12 rounded-lg shadow-md w-96 text-blue-600">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <button type="submit" className="w-full text-white bg-blue-600 py-2 rounded hover:bg-gray-200">Signup</button>
                </form>
                <div className="mt-4 text-center">
                    <a href="/login" className="bg-blue-600 hover:underline">Already have an account? Login</a>
                </div>
            </div>
        </div>
    );
