  ...
  return (
    <div className="flex flex-col md:flex-row md:p-10 bg-gray-50 gap-6">
      ...
      <div className="w-full md:w-1/4 md:sticky md:top-10 h-fit">
        <div className="bg-white p-6 rounded-xl shadow-lg relative flex flex-col items-center">
          {/* Profile Image Container with Background */}
          <div
            className="w-24 h-24 rounded-full border-4 border-white shadow-md bg-cover bg-center relative"
