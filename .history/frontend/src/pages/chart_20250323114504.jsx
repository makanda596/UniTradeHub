...
export default function ChatCard({user}) {
    ...
    const sendMessage = async(e)=>{
        ...
        try{
            const response = await axios.post('http://localhost:5000/chart/sendMessage/67dfbf2b0dbac3a89e4fe87e',{message})
    ...
    return (
        <div className="max-w-md w-full bg-white shadow-lg rounded-xl p-4">
            ...
            <div className="mt-3 flex items-center border-t pt-3">
                ...
                />
                <button className="ml-2 bg-blue-500 hover:bg-blue-600 text-white p-2 rounded-lg transition duration-200" onClick={sendMessage}>
                    Send
                </button>
            </div>
        </div>
