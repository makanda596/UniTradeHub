...
export default function ChatCard({ user }) {
    ...
    useEffect(() => {
        const fetchUserData = async () => {
            try {
                const response = await axios.get(`https://unitradehubback.onrender.com/auth/profile/${recieverId}`);
    ...
    const fetchMessages = async () => {
        try {
            const token = localStorage.getItem("token");
            const res = await axios.get(`https://unitradehubback.onrender.com/conversation/getconversation/${recieverId}`, {
                headers: { Authorization: `Bearer ${token}` },
            });
    ...
    const sendMessage = async (e) => {
        ...
        try { 
            const token = localStorage.getItem("token");
            await axios.post(
                `https://unitradehubback.onrender.com/chart/sendMessage/${recieverId}`,
