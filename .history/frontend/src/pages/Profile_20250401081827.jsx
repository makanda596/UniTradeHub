              ...
              <div className="pt-12 px-6 pb-2">
                ...
                <div className="mt-4 flex space-x-5">
                  <button
                    ...
                    className={`hiddden items-center justify-center px-4 py-2 rounded-lg ${user?.phoneNumber ? 'bg-green-500 hover:bg-green-600 text-white' : 'bg-gray-200 text-gray-500 cursor-not-allowed'} transition flex-1`}
                  >
