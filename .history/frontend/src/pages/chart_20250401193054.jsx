...
export default function ChatCard({ user }) {
    ...
    useEffect(() => {
        const fetchUserData = async () => {
            try {
                const response = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/profile/${recieverId}`);
    ...
    const fetchMessages = async () => {
        try {
            const token = localStorage.getItem("token");
            const res = await axios.get(`${import.meta.env.VITE_CONVERSATION}/getconversation/${recieverId}`, {
                headers: { Authorization: `Bearer ${token}` },
            });
    ...
    const sendMessage = async (e) => {
        ...
        try {
            const token = localStorage.getItem("token");
            await axios.post(
                `${import.meta.env.VITE_CHART_API}/sendMessage/${recieverId}`,
