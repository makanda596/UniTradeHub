...
const Reviewspage = ({ user }) => {
    ...
    return (
        <div className="max-w-4xl mx-auto mt-10 p-8 bg-white rounded-xl shadow-lg border border-gray-200">
            <h2 className="text-3xl font-bold text-center text-gray-800 mb-6">💬 User Reviews</h2>
            ...
            {loading ? (
                <div className="space-y-4">
                    {[1, 2, 3].map((index) => (
                        <div key={index} className="p-5 bg-gray-200 rounded-lg shadow-lg animate-pulse">
                ...
                <div className="space-y-6">
                    {reviews.map((review) => (
                        <div
                            key={review._id}
                            className="p-5 border-l-4 border-blue-400 bg-gray-50 shadow-md rounded-lg transition-all duration-300 hover:shadow-xl"
                        >
                            <div className="flex items-center gap-4">
