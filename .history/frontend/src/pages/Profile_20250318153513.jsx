...
const Profile = () => {
  ...
  try{
    const response = await axios.get('http://localhost:5000/auth/profile/67d1de6db4e9f9c5e2276538')
  ...
  return (
    <div className="flex flex-col items-center p-4 bg-gray-100 min-h-screen">
      ...
      <div className="w-full max-w-4xl bg-white shadow-lg rounded-lg overflow-hidden">
        ...
        <div className="p-6"><div className="w-1/3 bg-white p-4 shadow-lg rounded-lg">
