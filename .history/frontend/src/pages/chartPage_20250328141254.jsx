...
const ChatPage = ({ user = {} }) => {  // Added default value for user prop
    ...
    const fetchMessages = async (userId) => {
        try {
            ...
            const res = await axios.get(`http://localhost:5000/conversation/getconversation/${userId}`, {
    ...
    const handleSendMessage = async () => {
        ...
        try {
            ...
            await axios.post(`http://localhost:5000/conversation/sendMessage/${selectedUser}`, formData, {
                headers: {
