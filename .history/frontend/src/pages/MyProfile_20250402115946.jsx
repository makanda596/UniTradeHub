  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Fetch review count 
        const reviewsResponse = await axios.get(`https://unitradehubback.onrender.com/reviews/countReviews`, { 
          headers: { Authorization: `Bearer ${token}` },
        });
        setCountReviews(reviewsResponse.data);

        // Fetch post count
        const postsResponse = await axios.get(`https://unitradehubback.onrender.com/auth/countposts/${userId}`);
