make the upload image work dont use the base64 but what i justperovidedimport React, { useState, useEffect } from "react";
...
const Settings = () => {
    ...
    const handleSave = async () => {
        try {
            ...
            if (profilepic) {
                form.append("profilepic", profilepic); // ✅ append the file object
            }
