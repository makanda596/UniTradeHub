  ...
  return (
    ...
    <Routes>
      <Route path="/settings" element={<Settings />} />
          ...
          <Route path="/Profile/:id" element={<ProtectedRoute><Profile id="67d1de6db4e9f9c5e2276538" /></ProtectedRoute>} />
          <Route path="/MyProfile" element={<ProtectedRoute><MyProfile user={user} /></ProtectedRoute>} />
