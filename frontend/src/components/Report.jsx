...
const Report = ({ popUp, setPopUp, user }) => {
            ...
            {popUp && (
                <div className="fixed inset-0  flex items-centre justify-center z-50 backdrop-blur-xs">
                    <div className="bg-white p-4 rounded-xl h-44 shadow-2xl max-w-md w-full mx-4 transition-all duration-300 ease-out ">
                        <h3 className="text-xl font-bold text-gray-800 mb-2">Report User</h3>
                        <p className="text-gray-600 mb-2">
                            Please confirm if you want to report <span className="text-black font-bold text-xl">{user}</span> We'll review your report promptly.
                        </p>
